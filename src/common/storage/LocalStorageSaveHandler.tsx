...
/** Validates that a value loaded from localstorage representing font style is in an accepted format. */
function validateLoadedFontStyle(str: string | undefined): boolean {
  return str === "i" || str === "b" || str === "u" || str === "ib" || str === "iu" || str === "bu" || str === "ibu";
}
...
export function cleanLoadedTextStyle(obj: ITextStyle): ITextStyle {
  return {
    ...
    fontStyle: validateLoadedFontStyle(obj.fontStyle) ? obj.fontStyle : undefined,
  };
}
